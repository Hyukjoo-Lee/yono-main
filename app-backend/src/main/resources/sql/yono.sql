...
-- 삼성 iD SIMPLE카드
INSERT INTO card_benefit (BENEFIT_ID, CARD_ID, BENEFIT_TYPE, BENEFIT_TITLE, BENEFIT_VALUE, CREATED_AT, UPDATED_AT)
VALUES (CARD_BENEFIT_SEQ.nextval, 12, '가맹점', '국내외 가맹점 할인', '0.7%', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO card_benefit (BENEFIT_ID, CARD_ID, BENEFIT_TYPE, BENEFIT_TITLE, BENEFIT_VALUE, CREATED_AT, UPDATED_AT)
VALUES (CARD_BENEFIT_SEQ.nextval, 12, '가맹점', '국내외 가맹점 할인', '1%', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO card_benefit (BENEFIT_ID, CARD_ID, BENEFIT_TYPE, BENEFIT_TITLE, BENEFIT_VALUE, CREATED_AT, UPDATED_AT)
VALUES (CARD_BENEFIT_SEQ.nextval, 14, '음식점', '음식점 할인', '5%', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO card_benefit (BENEFIT_ID, CARD_ID, BENEFIT_TYPE, BENEFIT_TITLE, BENEFIT_VALUE, CREATED_AT, UPDATED_AT)
VALUES (CARD_BENEFIT_SEQ.nextval, 15, '의료', '다이소/올리브영', '1% 캐시백', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
