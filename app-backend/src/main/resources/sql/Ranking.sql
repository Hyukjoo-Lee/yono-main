...
VALUES (user_seq.nextval, 1, '김지훈', 'jh_ID', 65000, '2024-12', '/images/image1.jpg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO ranking (ranking_id, ranking_position, user_name, user_id, total_badges, ranking_month, ranking_img_url, created_at, updated_at)
VALUES (user_seq.nextval, 2, '박지은', 'je_ID', 60000, '2024-12', '/images/image2.jpg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO ranking (ranking_id, ranking_position, user_name, user_id, total_badges, ranking_month, ranking_img_url, created_at, updated_at)
VALUES (user_seq.nextval, 3, '김채림', 'cr_ID', 50000, '2024-12', '/images/image3.png', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO ranking (ranking_id, ranking_position, user_name, user_id, total_badges, ranking_month, ranking_img_url, created_at, updated_at)
VALUES (user_seq.nextval, 4, '이혁주', 'hj_ID', 40000, '2024-12', '/images/image4.jpg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO ranking (ranking_id, ranking_position, user_name, user_id, total_badges, ranking_month, ranking_img_url, created_at, updated_at)
VALUES (user_seq.nextval, 5, '허민경', 'mk_ID', 30000, '2024-12', '/images/image5.jpg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO ranking (ranking_id, ranking_position, user_name, user_id, total_badges, ranking_month, ranking_img_url, created_at, updated_at)
...
UPDATE ranking SET ranking_img_url='/images/image3.png' where user_id='iu_ID';
